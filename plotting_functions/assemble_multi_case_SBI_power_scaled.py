...
disp_csv_files = glob.glob(simDirPulsFSI + "/**/d_mag**SBI_power_scaled.csv", recursive = True)
vel_csv_files = glob.glob(simDirPulsFSI + "/**/v_mag**SBI_power_scaled.csv", recursive = True)
pressure_csv_files = glob.glob(simDirPulsFSI + "/**/p**SBI_power_scaled.csv", recursive = True)
vel_csv_files_cfd = glob.glob(simDirPulsCFD + "/**/v_mag**SBI_power_scaled.csv", recursive = True)
pressure_csv_files_cfd = glob.glob(simDirPulsCFD + "/**/p**SBI_power_scaled.csv", recursive = True)

disp_csv_files_Surg = glob.glob(simDirSurgFSI + "/**/d_mag**SBI_power_scaled.csv", recursive = True)
vel_csv_files_Surg = glob.glob(simDirSurgFSI + "/**/v_mag**SBI_power_scaled.csv", recursive = True)
pressure_csv_files_Surg = glob.glob(simDirSurgFSI + "/**/p**SBI_power_scaled.csv", recursive = True)
vel_csv_files_cfd_Surg = glob.glob(simDirSurgCFD + "/**/v_mag**SBI_power_scaled.csv", recursive = True)
pressure_csv_files_cfd_Surg = glob.glob(simDirSurgCFD + "/**/p**SBI_power_scaled.csv", recursive = True)
...
columns = ["max velocity SBIpowerscaled","temporal average velocity SBIpowerscaled","case name vel",
           "max velocity SBIpowerscaled CFD","temporal average velocity SBIpowerscaled CFD","case name vel CFD",
           "max displacement SBIpowerscaled","temporal average displacement SBIpowerscaled","case name disp",
           "max pressure SBIpowerscaled","temporal average pressure SBIpowerscaled","case name pres",
           "max pressure SBIpowerscaled CFD","temporal average pressure SBIpowerscaled CFD","case name pres CFD"]
...
csv_out_file=simDir+'/all_case_data_SBI_power_scaled.csv' # file name for SBIs
print(df.head())
