...
#simDir=$SCRATCH/7_0_Surgical/Modal_Shaking_Force
...
#simDir=$SCRATCH/7_0_Surgical/Surgical_Cases/Modal_Shaking_Force
...
simDir2=$SCRATCH/7_0_Surgical/Surgical_Cases/Pulsatile_CFD
...
for case in $simDir/*/; do
    #if [[ "$case" == *"MCA08"* ]] # || [[ "$case" == *"MCA06"* ]] || [[ "$case" == *"MCA07"* ]]
    if [[ "$case" != *"ppp"* ]] 
    then
        echo "running"
