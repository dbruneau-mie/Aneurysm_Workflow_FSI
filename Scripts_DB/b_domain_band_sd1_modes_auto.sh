...
source "automatic_bands_for_mode_shapes.txt"
echo $bands_auto
...
echo $str
python $workflow_location/postprocessing_h5py/create_mode_shapes.py --case=$case_path --mesh=$mesh_path --dt=$dt --start_t=$start_t_sd2 --end_t=$end_t_sd2 --dvp=d --save_deg=1 --stride=$stride_sd1 --bands=$bands_auto  --points=""
