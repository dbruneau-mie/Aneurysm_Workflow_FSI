...
python $SCRATCH/Aneurysm_Workflow_FSI/postprocessing_video/PlotAneuModeShapeMultiFrameQ.py $case_path $mesh_path $CameraPosition $CameraFocalPoint $CameraViewUp $CameraParallelScale $bands $r_sphere 10194 300
