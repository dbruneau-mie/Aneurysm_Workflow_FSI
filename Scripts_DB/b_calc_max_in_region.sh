...
echo $str
#python $workflow_location/postprocessing_h5py/create_visualizations_region.py --case=$case_path --mesh=$mesh_path --dt=$dt --start_t=$start_t_sd1 --end_t=$end_t_sd1 --dvp=v --save_deg=1 --stride=$stride_sd1 --bands="25,1400" --r_sphere=$r_sphere --x_sphere=$x_sphere --y_sphere=$y_sphere --z_sphere=$z_sphere 
python $workflow_location/postprocessing_h5py/create_visualizations_region.py --case=$case_path --mesh=$mesh_path --dt=$dt --start_t=0.9 --end_t=1.2 --dvp=v --save_deg=1 --stride=$stride_sd1 --bands="25,1400" --r_sphere=$r_sphere --x_sphere=$x_sphere --y_sphere=$y_sphere --z_sphere=$z_sphere 
