...
echo $str
#mpirun -n 30 python $workflow_location/postprocessing_fenics/compute_wss_fsi.py --case=$case_path --mesh=$mesh_path --dt=$dt --save_deg=2 --stride=1 # --start_t=$start_t_ROI --end_t=$end_t
