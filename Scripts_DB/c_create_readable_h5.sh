...
echo $str
python $workflow_location/postprocessing_fenics/compute_readable_h5.py --case=$case_path --mesh=$mesh_path --dt=$dt --save_deg=$save_deg_sim --stride=$stride_sd2 --start_t=$start_t_sd2 --end_t=$end_t_sd2
