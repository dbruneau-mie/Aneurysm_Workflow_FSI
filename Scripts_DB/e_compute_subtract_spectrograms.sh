...
python $workflow_location/postprocessing_h5py/subtract_spectrograms.py --case=$case_path --mesh=$mesh_path --end_t=$end_t_sd2 --start_t=$start_t_sd2 --save_deg=1 --r_sphere=$r_sphere --x_sphere=$x_sphere --y_sphere=$y_sphere --z_sphere=$z_sphere --stride=$stride_sd1 --dvp=d
