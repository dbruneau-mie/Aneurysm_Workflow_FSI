...
image_path = os.path.join(image_folder, 'pyvista_amplitude_lighting_lim_'+str(plot_lim)+mesh_name+'.png')
res_path = os.path.join(visualization_hi_pass_folder, "displacement_amplitude_25_to_1400.h5")
