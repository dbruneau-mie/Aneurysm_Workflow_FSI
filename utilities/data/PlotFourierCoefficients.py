...
np.savetxt("p_t.csv",np.transpose([np.append(t_values_10[:-1],np.append(t_values_10[:-1]+period,t_values_10+period*2)),np.append(p_t_10[:-1],np.append(p_t_10[:-1],p_t_10))]),delimiter=',',header='T (s),P (Pa)')
np.savetxt("Q_t",np.transpose([np.append(t_values_10[:-1],np.append(t_values_10[:-1]+period,t_values_10+period*2)),np.append(Q_values_10[:-1],np.append(Q_values_10[:-1],Q_values_10))]))
np.savetxt("Q_MCA_10",np.transpose([np.append(t_values_10[:-1],np.append(t_values_10[:-1]+period,t_values_10+period*2)),np.append(Q_values_10[:-1],np.append(Q_values_10[:-1],Q_values_10))]))
np.savetxt("Q_ICA",np.transpose([np.append(t_values_ICA[:-1],np.append(t_values_ICA[:-1]+period,t_values_ICA+period*2)),np.append(Q_values_ICA[:-1],np.append(Q_values_ICA[:-1],Q_values_ICA))]))
